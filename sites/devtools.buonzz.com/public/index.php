...
<body>
  <div class="wrapper">
      ...
      <section class="page1">
	    ...
	    <section class="page2">
	      <div class="page_container">
          <h1>Set your Git info</h1>
          <h2>Git needs to know who your are first! Login to the VM and set your Git settings</h2>
          <code class="html">
            vagrant ssh
  	      </code>
	    ...
	    <section class="page3">
	      <div class="page_container">
          <h1>Now start developing</h1>
          <h2>We had installed different Useful tools for you</h2>
          <div class="btns">
  	        <ul>
